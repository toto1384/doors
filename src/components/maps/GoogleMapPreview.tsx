...
import { useGoogleMaps } from "@/src/components/providers/GoogleMapsProvider";
...
export function GoogleMapPreview({
	...
	if (error) {
		return (
			<div className={`bg-gray-700 rounded-lg flex items-center justify-center ${className}`} style={{ height }}>
	...
	return <div ref={mapRef} className={`rounded-lg overflow-hidden ${className}`} style={{ height }} />;
}
