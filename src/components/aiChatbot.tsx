...
function useChooseActions({ setMessages, }: { setMessages: React.Dispatch<React.SetStateAction<Message[]>>, }) {
    ...
    const { clientToolFunction: setIntentFunction } = useClientToolChoice({
        choices: [
            {
                value: 'Cumpara/Inchiriaza', key: 'house', icon: <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {
                value: 'Listeaza Proprietate', key: 'apartment', icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
