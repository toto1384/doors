...
const ringClassName =
	"focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 dark:aria-invalid:ring-destructive/40 aria-invalid:ring-destructive/20 ";
...
export function MultiSelectValue({
	...
	if (selectedValues.size === 0 && placeholder) {
		return (
			<span className={cn("min-w-0 overflow-hidden font-normal text-muted-foreground", className)}>{placeholder}</span>
		);
	}
