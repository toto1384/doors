...
export function FacilitiesSelector({
	...
	className?: string;
	facilities: (typeof Facilities)[number][];
	setFacilities: (value: (typeof Facilities)[number][]) => void;
}) {
	return (
		<MultiSelect values={facilities} onValuesChange={(value) => setFacilities(value as (typeof Facilities)[number][])}>
