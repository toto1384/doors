...
import { usePropertyAddStore } from "@/src/routes/__root";
...
function PropertyAdd() {
	...
	const { partialProperty, titlesAndDescriptions, setPartialProperty, titleAndDescResolver, postedStatus } =
		usePropertyAddStore(
			useShallow((state) => ({
	...
	return (
		<div className="flex flex-col border rounded-lg mx-3 min-h-[90dvh]">
			<div className="border-b px-3">
				<div className="flex flex-col gap-2 w-full pt-2 pb-2 md:pt-4 md:pb-5 ">
					<h1 className="text-xl font-light" data-testid="title">
						{t("title")}
					</h1>
